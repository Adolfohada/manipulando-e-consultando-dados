...
update tb_aesthetic set idade = 19, sexo = 'M', rede = 'nï¿½o tem' where nome = 'RamonDinoss'; -- aqui atualizei e alterei os dados dele

select * from TB_AESTHETIC; -- para mostrar para mim a tabela

select nome as "Nome Aesthetic", idade, sexo, rede from tb_aesthetic; -- deixa na parte de visualizaï¿½ï¿½o com outro nome a vista 

select * from tb_aesthetic where nome = 'Miyuki'; -- estou selecionando a linha no qual desejo

select * from tb_aesthetic where idade >= 30; -- mostrar as pessoas que sï¿½o maior de 30 anos e se quiser colocar para pessoas que sï¿½o tenham somente 30 anos ai teria que colocar <>

select * from tb_aesthetic where to_char(rede) = 'instagram'; --mostra somente as pessoas que tem a rede - instagram

select * from tb_aesthetic where not(idade >= 30 and rede = 'instagram'); --aqui exibi as pessoas que nï¿½o sï¿½o maior que 30 anos e conjunto de que nï¿½o tenham instagram
